...
> | Kimchi Mobile (www.kimchimobile.com) | WordPress | — | 외국인 통신/eSIM — **YMYL(금융·통신)** |
...
## A. Next.js App Router 구현 (Passome / Korvia / ACT)

> 검증 기준: Next.js 16.2.x stable line(16 stable = 2025-10, docs lastUpdated 2026-03-03). `app/sitemap.ts` v13.3.0 도입, `alternates.languages` 지역화 v14.2.0, `generateSitemaps` id의 Promise화 v16.0.0. (nextjs.org/docs)
...
export default function robots(): MetadataRoute.Robots {
  return {
    rules: [
      ...
      { userAgent: '*', allow: '/', disallow: ['/admin/', '/api/', '/_next/', '/draft/'] },
